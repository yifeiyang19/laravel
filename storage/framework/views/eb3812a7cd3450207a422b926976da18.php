...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><?php echo e(__('modify articles')); ?></div>
                <div class="card-body">
                <form method="POST">
                    <?php echo csrf_field(); ?>
                   <div class="row mb-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old("title")??$article->title); ?>">
...
unset($__errorArgs, $__bag); ?>" name="content" style="display:none;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/laravel.com/laravel/resources/views/article/edit.blade.php ENDPATH**/ ?>